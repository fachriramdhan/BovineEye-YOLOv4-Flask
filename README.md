...
<table width="900px">
  <thead>
    <tr>
      <th width="450px">💻 Frontend (Client Side)</th>
      <th width="450px">⚙️ Backend & AI Engine (Server Side)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td valign="top">
        <table width="100%">
          <tr>
            ...
            <td><small>Penyusunan struktur antarmuka web yang responsif dan semantik.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-TailwindCSS-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white"></td>
            <td><small>Framework CSS untuk desain UI modern dengan pendekatan <i>utility-first</i>.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black"></td>
            <td><small>Menangani logika sisi klien, integrasi API, dan interaktivitas DOM.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-FontAwesome-339AF0?style=flat-square&logo=font-awesome&logoColor=white"></td>
            <td><small>Penyedia ikon vektor untuk memperkuat visualisasi navigasi sistem.</small></td>
          </tr>
        </table>
      </td>
      <td valign="top">
        <table width="100%">
          <tr>
            ...
            <td><small>Bahasa pemrograman utama untuk pengolahan data dan algoritma AI.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-Flask-000000?style=flat-square&logo=flask&logoColor=white"></td>
            <td><small>Micro-framework untuk menjembatani model AI dengan antarmuka web.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white"></td>
            <td><small>Library untuk pra-pemrosesan citra digital sebelum proses deteksi.</small></td>
          </tr>
          <tr>
            <td><img src="https://img.shields.io/badge/-YOLOv4-00FFFF?style=flat-square&logo=ai&logoColor=black"></td>
            <td><small>Algoritma <i>Deep Learning</i> inti untuk deteksi objek (penyakit IBK).</small></td>
          </tr>
        </table>
      </td>
    </tr>
